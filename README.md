...
Reusable JavaScript packages for standalone point-and-click games. **Version 3.2.1 · MIT · Node.js 22+ tooling · No browser runtime dependencies.**
...
```sh
npm install --save-exact --allow-remote=root https://github.com/paulbowler/interactive-fiction/releases/download/v3.2.1/paulbowler-if-engine-3.2.1.tgz https://github.com/paulbowler/interactive-fiction/releases/download/v3.2.1/paulbowler-if-browser-3.2.1.tgz
```
