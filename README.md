...
Ordinary taking, dropping, containers, locks, inventory and movement need world properties, not bespoke scripts. The [API guide](docs/api.md) describes the world schema and supported actions.
