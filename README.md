...
Reusable JavaScript packages for standalone point-and-click games. **Version 2.1.0 · MIT · Node.js 22+ tooling · No browser runtime dependencies.**
...
```sh
npm install --save-exact --allow-remote=root https://github.com/paulbowler/interactive-fiction/releases/download/v2.1.0/paulbowler-if-engine-2.1.0.tgz https://github.com/paulbowler/interactive-fiction/releases/download/v2.1.0/paulbowler-if-browser-2.1.0.tgz
```
